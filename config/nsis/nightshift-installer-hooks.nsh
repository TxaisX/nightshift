; electron-builder NSIS hooks for the Nightshift Windows installer.
;
; electron-builder accepts exactly ONE `nsis.include` file, so every customInstall /
; customUnInstall hook Nightshift needs lives here.

; ---------------------------------------------------------------------------
; Markdown "Open with Nightshift" (issue #10138)
;
...
; uninstalling Nightshift would leave .md pointing at a deleted ProgID.
;
; These writes are additive only. Registering a ProgID plus an OpenWithProgids
; hint and an Applications\<exe>\SupportedTypes entry puts Nightshift in Explorer's
...
; ---------------------------------------------------------------------------
!define MARKDOWN_PROGID "Nightshift.Markdown"

!macro NIGHTSHIFT_REGISTER_MARKDOWN_OPEN_WITH EXT
...
!macro NIGHTSHIFT_UNREGISTER_MARKDOWN_OPEN_WITH EXT
...
!macro customInstall
  ...
  !insertmacro NIGHTSHIFT_REGISTER_MARKDOWN_OPEN_WITH ".md"
  !insertmacro NIGHTSHIFT_REGISTER_MARKDOWN_OPEN_WITH ".markdown"
  !insertmacro NIGHTSHIFT_REGISTER_MARKDOWN_OPEN_WITH ".mdx"
...
; %LOCALAPPDATA%\Nightshift\daemon-host so that app UPDATES cannot kill it —
...
!macro customUnInstall
  ${ifNot} ${isUpdated}
    ...
    Sleep 500
    RMDir /r "$LOCALAPPDATA\Nightshift\daemon-host"
  ${endIf}
  ...
  !insertmacro NIGHTSHIFT_UNREGISTER_MARKDOWN_OPEN_WITH ".md"
  !insertmacro NIGHTSHIFT_UNREGISTER_MARKDOWN_OPEN_WITH ".markdown"
  !insertmacro NIGHTSHIFT_UNREGISTER_MARKDOWN_OPEN_WITH ".mdx"
  System::Call "shell32::SHChangeNotify(i,i,i,i) (0x08000000, 0x1000, 0, 0)"
!macroend
