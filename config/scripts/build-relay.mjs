...
const REQUIRED_ADDON_ARCHES = (process.env.NIGHTSHIFT_REQUIRE_RELAY_NATIVE_ADDONS ?? '')
  .split(',')
...
const OUT_ROOT = process.env.NIGHTSHIFT_RELAY_OUT_ROOT ?? join(ROOT, 'out', 'relay')
