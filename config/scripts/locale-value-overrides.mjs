...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore Nightshift': 'Explorar Nightshift',
  ...
  ko: {
    ...
    'Try Again': '다시 시도',
    'Restart now': '지금 재시작',
    'Restart Nightshift': 'Nightshift 재시작',
    ...
    'Connect to Nightshift': 'Nightshift에 연결',
    'USB Devices': 'USB 장치',
    ...
    'Kill all': '모두 강제 종료',
    'kill all': '모두 종료',
    'Collapse Nightshift': 'Nightshift 접기',
    'Search skills': '스킬 검색',
    'Search blocks': '블록 검색',
    teams: '팀',
    passing: '통과',
  ...
  zh: {
    ...
    'Try Again': '重试',
    'Restart now': '立即重启',
    'Restart Nightshift': '重启 Nightshift',
    'Hide sleeping': '隐藏休眠项',
    ...
    'Connect to Nightshift': '连接到 Nightshift',
    'USB Devices': 'USB 设备',
    ...
    'Kill all': '全部强制结束',
    'kill all': '全部结束',
    'Collapse Nightshift': '折叠 Nightshift',
    'Search skills': '搜索技能',
    'Search blocks': '搜索块',
    teams: '团队',
    passing: '通过',
  ...
  ja: {
    ...
    'Try Again': '再試行',
    'Restart now': '今すぐ再起動',
    'Restart Nightshift': 'Nightshift を再起動',
    ...
    'Connect to Nightshift': 'Nightshift に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse Nightshift': 'Nightshift を折りたたむ',
