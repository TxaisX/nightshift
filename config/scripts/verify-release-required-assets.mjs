...
export function getRequiredReleaseAssetNames(tag) {
  ...
  return [
    ...
    `nightshift-ide_${version}_amd64.deb`,
    `nightshift-ide_${version}_arm64.deb`,
    `nightshift-ide-${version}.x86_64.rpm`,
    `nightshift-ide-${version}.aarch64.rpm`,
    'nightshift-windows-setup.exe',
    'nightshift-windows-setup.exe.blockmap',
    `Nightshift-${version}-mac.zip`,
    `Nightshift-${version}-mac.zip.blockmap`,
    `Nightshift-${version}-arm64-mac.zip`,
    `Nightshift-${version}-arm64-mac.zip.blockmap`,
    'nightshift-macos-x64.dmg',
    'nightshift-macos-x64.dmg.blockmap',
    'nightshift-macos-arm64.dmg',
    'nightshift-macos-arm64.dmg.blockmap'
  ]
}
