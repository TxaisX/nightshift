...
// Asserts that the telemetry compile-time constants — `NIGHTSHIFT_BUILD_IDENTITY`
// and `NIGHTSHIFT_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Nightshift.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Nightshift.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `NIGHTSHIFT_BUILD_IDENTITY` and `NIGHTSHIFT_POSTHOG_WRITE_KEY` with their
