...
setlocal
set "SCRIPT_DIR=%~dp0"
set "LAUNCHER=%SCRIPT_DIR%nightshift.exe"

if not exist "%LAUNCHER%" (
  echo Unable to locate the native Nightshift CLI launcher at "%LAUNCHER%" 1>&2
  exit /b 1
)
...
:unsafe_body
echo nightshift.cmd cannot safely forward orchestration message bodies. Use "%LAUNCHER%" instead. 1>&2
exit /b 2
