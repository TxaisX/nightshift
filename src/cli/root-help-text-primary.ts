export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  '',
  'Startup:',
  '  open                      Launch Nightshift and wait for the runtime to be reachable',
  '  serve                     Start a headless Nightshift runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Nightshift and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Nightshift CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Nightshift skills globally via the community skills CLI',
  '  skills update             Update already-installed Nightshift skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Nightshift runtime from a pairing code',
  '  environment list          List saved remote Nightshift runtimes',
  '  environment show          Show one saved remote Nightshift runtime',
  '  environment rm            Remove a saved remote Nightshift runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Nightshift automations',
  '  automations show          Show one Nightshift automation',
  '  automations create        Create a scheduled Nightshift automation',
  '  automations edit          Edit a Nightshift automation',
  '  automations remove        Remove a Nightshift automation and its run history',
  '  automations run           Run a Nightshift automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Nightshift',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Nightshift',
  '  repo add                  Add a project to Nightshift by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Nightshift-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Nightshift-managed worktree for the current directory',
  '  worktree create           Create a new Nightshift-managed worktree',
  '  worktree set              Update Nightshift metadata for a worktree',
  '  worktree rm               Remove a worktree from Nightshift and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Nightshift editor',
  '  file diff                 Open a workspace file diff in the Nightshift editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Nightshift-managed terminals',
  ...
  '  emulator list             List available/running emulators (Nightshift-managed + raw serve-sim)',
