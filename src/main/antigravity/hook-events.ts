export const ANTIGRAVITY_HOOK_BUNDLE_NAME = 'nightshift-status'
...
// only "ask" defers to the user's permission config — "allow" would auto-approve every tool call Nightshift observes.
