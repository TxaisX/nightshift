 ...
 *
 * Probes are always secondary to Nightshift automation list and mutation traffic, so
...
export class ExternalAutomationProbeScheduler {
  ...
  /** Held for the duration of Nightshift list/mutation work; queued probes wait behind it. */
