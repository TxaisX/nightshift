...
export abstract class AgentBrowserBridgeExecution extends AgentBrowserBridgeTabs {
  ...
  protected async execAgentBrowser(
    ...
    // Why: a restarted named daemon auto-launches Chrome unless every invocation reasserts Nightshift's CDP owner.
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        child = execFile(
          ...
          // Why windowsHide: agent-browser is console-subsystem and Nightshift's main
