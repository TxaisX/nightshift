...
/**
 * Run one native Query control method under Nightshift's deadline and error classification.
 *
...
/** The native control surface Nightshift drives, one method per Query control request. */
