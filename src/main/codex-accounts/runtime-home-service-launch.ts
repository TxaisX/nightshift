...
export abstract class CodexRuntimeHomeLaunch extends CodexRuntimeHomeRouting {
  protected initializeLastSyncedState(): void {
    ...
    // Why: WSL-managed homes never touch host ~/.codex; treating one as "last synced" makes cold start mangle host auth Nightshift never touched.
  ...
  prepareForCodexLaunch(
    ...
    if (selfContainedAccount) {
      ...
      // system default without injecting a path Nightshift cannot prove it owns.
    }
