...
async function main(): Promise<void> {
  ...
  const e2eProbeFile = process.env.NIGHTSHIFT_E2E_LOGIN_SESSION_PROBE_FILE
...
// load check — see config/scripts/build-nightshiftd.mjs).
const isDirectExecution = !process.env.VITEST && !process.env.NIGHTSHIFT_DAEMON_ENTRY_LOAD_CHECK
