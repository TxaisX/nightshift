 ...
 * reported nightshiftd's version for both would hide exactly that.
 */
...
// Leave history sessions marked "unclean" so a daemon crash while Nightshift is closed stays recoverable.
