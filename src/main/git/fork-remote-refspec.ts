...
// (user, agent, or Nightshift's own Fetch action) imports the fork's entire branch set --
...
// the branches Nightshift actually knows about (see #17828).
//
// The tracked-branch refspec source carries a trailing `*` (`refs/heads/<branch>*`)
// rather than being a literal exact match. This is deliberate: Nightshift is terminal-centric
