...
// card at once, short enough that a PR opened outside Nightshift shows up promptly.
...
/** Drop the cached scan after a mutation Nightshift itself performed (PR create),
