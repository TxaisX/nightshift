...
export async function resolvePRForBranchOutcome(input: {
  ...
  // Why: a visible PR can be merged outside Nightshift; keep a caller-marked fallback fresh even when GitHub no longer reports it by branch (e.g. deleted heads).
