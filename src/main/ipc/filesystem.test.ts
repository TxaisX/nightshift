...
describe('registerFilesystemHandlers', () => {
  ...
  it('allows readDir when a registered worktree resolves to a macOS canonical alias', async () => {
    const aliasWorktreePath = path.resolve('/var/folders/nightshift/worktrees/feature')
    const canonicalWorktreePath = path.resolve('/private/var/folders/nightshift/worktrees/feature')
