...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (NIGHTSHIFT_E2E_HEADLESS keeps a live but
...
// churn to Nightshift just to observe a handful of shallow paths. The replacements
...
// Nightshift's own worktree operations notify the renderer directly.
