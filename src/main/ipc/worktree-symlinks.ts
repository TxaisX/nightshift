...
// 'share': always symlink (nightshift.yaml sharedDirectories). An APFS clone would give
...
/** Symlink `nightshift.yaml` `worktree.sharedDirectories` into a freshly-created
