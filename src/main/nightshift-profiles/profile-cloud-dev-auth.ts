...
function defaultDevOrganizations(): NightshiftCloudOrgSummary[] {
  return [
...
function devCapabilities(): NightshiftCloudCapabilities {
  return {
    flags: {
      share: true,
      team: true,
...
export function createDevNightshiftCloudSession(
  args: {
    localProfileId?: string
    cloudProfileId?: string
    orgId?: string
  } = {}
): NightshiftCloudSessionExchangeResponse {
