...
export type CreateCloudLinkedNightshiftProfileRecordResult = NightshiftProfileListState & {
...
function toLocalProfile(profile: NightshiftProfileSummary, now: number): NightshiftProfileSummary {
...
export function createCloudLinkedNightshiftProfileRecord(
  cloud: NightshiftProfileCloudSummary,
  args: { name?: string },
  userDataPath: string
): CreateCloudLinkedNightshiftProfileRecordResult {
...
export function linkNightshiftProfileToCloud(
  profileId: string,
  cloud: NightshiftProfileCloudSummary,
  userDataPath: string
): NightshiftProfileListState {
...
export function unlinkNightshiftProfileFromCloud(
  profileId: string,
  userDataPath: string
): NightshiftProfileListState {
  const index = loadOrCreateProfileIndex(userDataPath)
