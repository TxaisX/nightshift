...
export function nightshiftdAgentBrowserNativeName(
...
export function resolveNightshiftdAgentBrowserBinary(): string | null {
  const name = nightshiftdAgentBrowserNativeName(platform(), arch())
  const candidates = [
