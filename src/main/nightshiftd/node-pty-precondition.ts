...
const PROBE_OK_TOKEN = 'NIGHTSHIFT_NODE_PTY_LOAD_OK'
const NO_BINARY_TOKEN = 'NIGHTSHIFT_NODE_PTY_NO_BINARY'
const LOAD_ERROR_TOKEN = 'NIGHTSHIFT_NODE_PTY_LOAD_ERROR'
