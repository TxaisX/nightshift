export function getStatusPluginPostSource(hookPathname: string): string[] {
  return [
    ...
    '  // rewritten by a newer Nightshift since the last call. Pane/tab/worktree IDs',
    '  // stay on process.env because they are per-PTY (stable for the life of',
    '  // the OpenCode process), not per-Nightshift-instance.',
    ...
    '    // because Nightshift is unavailable or the local loopback request failed.',
    '    return false;',
    '  } finally {',
