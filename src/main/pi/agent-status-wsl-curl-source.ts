export function getPiAgentStatusWslCurlSourceLines(): string[] {
  return [
    ...
    '  const windowsPort = process.env.NIGHTSHIFT_AGENT_HOOK_PORT',
    '  const windowsToken = process.env.NIGHTSHIFT_AGENT_HOOK_TOKEN',
    ...
    "        '-H', `X-Nightshift-Agent-Hook-Token: ${windowsToken}`,",
    "        '--data-binary', '@-',",
    '        windowsUrl',
    '      ],',
