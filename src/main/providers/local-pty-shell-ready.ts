 ...
 * that point each shell at its Nightshift wrapper (which emits the OSC 777 marker the scanner detects).
 */
...
/** Args that point bash at Nightshift's rcfile, or null when it is not usable. */
