...
export type PtyProcessInfo = {
  ...
  worktreeId?: string
  /** Trusted NIGHTSHIFT_TERMINAL_HANDLE exported into this PTY, when known. */
  ...
  hostAgeMs?: number
  /** True when the host spawned this PTY for a Nightshift pane, false for a bare host shell. Absent from
