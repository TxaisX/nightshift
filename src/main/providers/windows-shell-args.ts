...
export const NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV =
  'NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT call %${NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT%%${NIGHTSHIFT_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Nightshift detects.
