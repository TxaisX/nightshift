...
const OPENCODE_SESSION_PARTITION = 'nightshift-opencode-go-rate-limit-fetch'
...
export async function createOpenCodeRequestSession(
  ...
  // The isolated cookie jar must still honor Nightshift, environment, and system proxies.
