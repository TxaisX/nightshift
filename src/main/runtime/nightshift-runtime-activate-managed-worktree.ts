...
import { NightshiftRuntimeWithListManagedWorktrees } from './nightshift-runtime-list-managed-worktrees'
...
export class NightshiftRuntimeWithActivateManagedWorktree extends NightshiftRuntimeWithListManagedWorktrees {
  async activateManagedWorktree(
     ...
     *  renderer holds the sleeping records (headless `nightshift serve`), so nothing
