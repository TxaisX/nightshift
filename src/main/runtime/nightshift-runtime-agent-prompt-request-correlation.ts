import { NightshiftRuntimeWithSerializeAgentPromptSubmission } from './nightshift-runtime-serialize-agent-prompt-submission'
...
export class NightshiftRuntimeWithAgentPromptRequestCorrelation extends NightshiftRuntimeWithSerializeAgentPromptSubmission {
