...
import { NightshiftRuntimeWithPerformMobileSessionPtyRecordsRefresh } from './nightshift-runtime-perform-mobile-session-pty-records-refresh'
import type {
...
export class NightshiftRuntimeWithApplyMobileSessionTabNavigation extends NightshiftRuntimeWithPerformMobileSessionPtyRecordsRefresh {
