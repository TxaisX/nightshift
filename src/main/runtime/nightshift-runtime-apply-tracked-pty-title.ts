...
import { NightshiftRuntimeWithGetUnpersistedTrackedTitleForPty } from './nightshift-runtime-get-unpersisted-tracked-title-for-pty'
...
export class NightshiftRuntimeWithApplyTrackedPtyTitle extends NightshiftRuntimeWithGetUnpersistedTrackedTitleForPty {
