...
import { NightshiftRuntimeWithPtyForegroundProcessReads } from './nightshift-runtime-pty-foreground-process-reads'
import type {
...
export class NightshiftRuntimeWithAutomationOperations extends NightshiftRuntimeWithPtyForegroundProcessReads {
