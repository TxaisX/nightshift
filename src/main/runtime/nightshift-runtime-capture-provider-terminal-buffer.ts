...
import { NightshiftRuntimeWithSerializeTerminalBufferFromAvailableState } from './nightshift-runtime-serialize-terminal-buffer-from-available-state'
...
import type { RuntimeTerminalProjection } from './nightshift-runtime-core'
import { DEFAULT_TERMINAL_READ_LIMIT } from './terminal-tail-limits'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { projectTerminalTailLines } from './nightshift-runtime-terminal-projection'

export class NightshiftRuntimeWithCaptureProviderTerminalBuffer extends NightshiftRuntimeWithSerializeTerminalBufferFromAvailableState {
