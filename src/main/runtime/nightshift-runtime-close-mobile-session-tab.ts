...
import { NightshiftRuntimeWithRefuseUnattributedMobileSessionTabClose } from './nightshift-runtime-refuse-unattributed-mobile-session-tab-close'
import type {
...
export class NightshiftRuntimeWithCloseMobileSessionTab extends NightshiftRuntimeWithRefuseUnattributedMobileSessionTabClose {
