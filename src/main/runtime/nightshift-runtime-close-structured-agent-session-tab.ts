...
import { NightshiftRuntimeWithCloseMobileSessionTab } from './nightshift-runtime-close-mobile-session-tab'
import type {
...
export class NightshiftRuntimeWithCloseStructuredAgentSessionTab extends NightshiftRuntimeWithCloseMobileSessionTab {
