...
import { NightshiftRuntimeWithSyncWindowGraph } from './nightshift-runtime-sync-window-graph'
...
export class NightshiftRuntimeWithCollectMobileVisibleGraphChangedWorktrees extends NightshiftRuntimeWithSyncWindowGraph {
  ...
  supportsAuthoritativeSessionTabsInventory(): boolean {
    return process.env.NIGHTSHIFT_E2E_DISABLE_AUTHORITATIVE_SESSION_TABS_INVENTORY !== '1'
  }
