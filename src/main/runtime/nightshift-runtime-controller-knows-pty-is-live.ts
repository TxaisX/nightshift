...
import { NightshiftRuntimeWithResolveTerminalPane } from './nightshift-runtime-resolve-terminal-pane'
import { PROVEN_ABSENT_LEAF_PTY_TTL_MS } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithControllerKnowsPtyIsLive extends NightshiftRuntimeWithResolveTerminalPane {
