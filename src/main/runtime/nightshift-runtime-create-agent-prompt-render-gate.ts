...
import { NightshiftRuntimeWithWriteTerminalAgentPrompt } from './nightshift-runtime-write-terminal-agent-prompt'
import {
...
export class NightshiftRuntimeWithCreateAgentPromptRenderGate extends NightshiftRuntimeWithWriteTerminalAgentPrompt {
