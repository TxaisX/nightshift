...
import { NightshiftRuntimeWithCreateManagedWorktree } from './nightshift-runtime-create-managed-worktree'
...
export class NightshiftRuntimeWithCreateManagedRemoteWorktree extends NightshiftRuntimeWithCreateManagedWorktree {
