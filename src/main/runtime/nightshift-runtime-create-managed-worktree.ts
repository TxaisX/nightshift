...
import { NightshiftRuntimeWithGetWorktreeTerminalProvisioningHost } from './nightshift-runtime-get-worktree-terminal-provisioning-host'
...
export class NightshiftRuntimeWithCreateManagedWorktree extends NightshiftRuntimeWithGetWorktreeTerminalProvisioningHost {
