...
import { NightshiftRuntimeWithMaybeHydrateHeadlessFromRenderer } from './nightshift-runtime-maybe-hydrate-headless-from-renderer'
...
export class NightshiftRuntimeWithCreatePtyHeadlessTerminalState extends NightshiftRuntimeWithMaybeHydrateHeadlessFromRenderer {
