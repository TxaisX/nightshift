...
import { NightshiftRuntimeWithResolveMobileSessionTerminalCommand } from './nightshift-runtime-resolve-mobile-session-terminal-command'
...
export class NightshiftRuntimeWithCreateRuntimeOwnedMobileSessionTerminal extends NightshiftRuntimeWithResolveMobileSessionTerminalCommand {
