...
import { NightshiftRuntimeWithApplyTrackedPtyTitle } from './nightshift-runtime-apply-tracked-pty-title'
import type {
...
export class NightshiftRuntimeWithCreateTerminalSideEffectCommandCodeDetector extends NightshiftRuntimeWithApplyTrackedPtyTitle {
