...
import { NightshiftRuntimeWithTerminalCreateDeduplication } from './nightshift-runtime-terminal-create-deduplication'
import * as dependencies from './nightshift-runtime-create-terminal-dependencies'
import { createDesktopTerminal } from './nightshift-runtime-create-terminal-desktop'
import { buildRuntimeAgentTeamsLaunchPlan } from './nightshift-runtime-agent-teams-launch-plan'
import { createPtySpawnCommitReporter } from './nightshift-runtime-report-pty-spawn-commit'

export class NightshiftRuntimeWithCreateTerminal extends NightshiftRuntimeWithTerminalCreateDeduplication {
  async createTerminal(
    ...
    if (shouldCreateInBackground) {
      ...
      try {
        ...
        const baseEnv = {
          ...launchOpts.env,
          ...(launchToken ? { NIGHTSHIFT_AGENT_LAUNCH_TOKEN: launchToken } : {})
        }
