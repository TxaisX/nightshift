...
import { NightshiftRuntimeWithScheduleWaitBlockedCheck } from './nightshift-runtime-schedule-wait-blocked-check'
...
export class NightshiftRuntimeWithEmitDaemonPtyTransientFact extends NightshiftRuntimeWithScheduleWaitBlockedCheck {
  ...
  getTerminalSideEffectSnapshot(ptyId: string): TerminalSideEffectBatch | null {
    ...
    // tracker title Nightshift synthesized from hooks — but with no tracker title it is the pane's
