...
import { NightshiftRuntimeWithPreservedBranchCleanup } from './nightshift-runtime-preserved-branch-cleanup'
import { RuntimeFileCommands } from './nightshift-runtime-files'
...
export class NightshiftRuntimeWithFileCommands extends NightshiftRuntimeWithPreservedBranchCleanup {
