...
import { NightshiftRuntimeWithStopRequestedPtyIds } from './nightshift-runtime-stop-requested-pty-ids'
...
export class NightshiftRuntimeWithFitOverrideListeners extends NightshiftRuntimeWithStopRequestedPtyIds {
