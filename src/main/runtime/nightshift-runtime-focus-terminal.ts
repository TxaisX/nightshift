...
import { NightshiftRuntimeWithWaitForLeafPtyId } from './nightshift-runtime-wait-for-leaf-pty-id'
...
export class NightshiftRuntimeWithFocusTerminal extends NightshiftRuntimeWithWaitForLeafPtyId {
  async focusTerminal(
    handle: string,
