...
import { NightshiftRuntimeWithResolveWorktreeRemovalTarget } from './nightshift-runtime-resolve-worktree-removal-target'
...
export class NightshiftRuntimeWithGetAgentSessionExecutionNamespace extends NightshiftRuntimeWithResolveWorktreeRemovalTarget {
