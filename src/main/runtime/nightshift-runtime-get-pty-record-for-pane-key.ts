...
import { NightshiftRuntimeWithPruneMobileSessionTabGroupLayout } from './nightshift-runtime-prune-mobile-session-tab-group-layout'
...
export class NightshiftRuntimeWithGetPtyRecordForPaneKey extends NightshiftRuntimeWithPruneMobileSessionTabGroupLayout {
