...
import { NightshiftRuntimeWithHasExactPersistedTerminalSurfaceIdentity } from './nightshift-runtime-has-exact-persisted-terminal-surface-identity'
import type {
...
export class NightshiftRuntimeWithGetRuntimeId extends NightshiftRuntimeWithHasExactPersistedTerminalSurfaceIdentity {
  getRuntimeId(): string {
