...
import { NightshiftRuntimeWithAdoptTerminalOrphansFromInventory } from './nightshift-runtime-adopt-terminal-orphans-from-inventory'
import type {
...
import { TERMINAL_INTERACTIVE_WAIT_PROBE_TIMEOUT_MS } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithGetTerminalInteractiveWait extends NightshiftRuntimeWithAdoptTerminalOrphansFromInventory {
