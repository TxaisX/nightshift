...
import { NightshiftRuntimeWithEmitDaemonPtyTransientFact } from './nightshift-runtime-emit-daemon-pty-transient-fact'
...
export class NightshiftRuntimeWithGetUnpersistedTrackedTitleForPty extends NightshiftRuntimeWithEmitDaemonPtyTransientFact {
