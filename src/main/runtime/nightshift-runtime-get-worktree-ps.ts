...
import { NightshiftRuntimeWithStructuredAgentSessionRecoverTuiOwner } from './nightshift-runtime-structured-agent-session-recover-tui-owner'
import { DEFAULT_WORKTREE_PS_LIMIT } from './nightshift-runtime-postlude'
...
export class NightshiftRuntimeWithGetWorktreePs extends NightshiftRuntimeWithStructuredAgentSessionRecoverTuiOwner {
  async getWorktreePs(
