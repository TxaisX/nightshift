...
import { NightshiftRuntimeWithActivateManagedWorktree } from './nightshift-runtime-activate-managed-worktree'
import type {
...
export class NightshiftRuntimeWithGetWorktreeTerminalProvisioningHost extends NightshiftRuntimeWithActivateManagedWorktree {
