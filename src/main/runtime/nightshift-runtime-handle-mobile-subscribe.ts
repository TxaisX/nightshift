...
import { NightshiftRuntimeWithApplyLayout } from './nightshift-runtime-apply-layout'

export class NightshiftRuntimeWithHandleMobileSubscribe extends NightshiftRuntimeWithApplyLayout {
