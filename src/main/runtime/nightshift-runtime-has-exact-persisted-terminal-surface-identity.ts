...
import { NightshiftRuntimeWithAutomationOperations } from './nightshift-runtime-automation-operations'
import {
...
export class NightshiftRuntimeWithHasExactPersistedTerminalSurfaceIdentity extends NightshiftRuntimeWithAutomationOperations {
