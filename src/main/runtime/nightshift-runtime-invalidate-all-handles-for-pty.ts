...
import { NightshiftRuntimeWithResolveKnownWorkspaceFileTarget } from './nightshift-runtime-resolve-known-workspace-file-target'
import type { PtyIncarnationId } from '../../shared/pty-incarnation'

export class NightshiftRuntimeWithInvalidateAllHandlesForPty extends NightshiftRuntimeWithResolveKnownWorkspaceFileTarget {
