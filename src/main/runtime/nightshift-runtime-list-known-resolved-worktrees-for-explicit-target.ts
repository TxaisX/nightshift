...
import { NightshiftRuntimeWithResolveWorktreeSelector } from './nightshift-runtime-resolve-worktree-selector'
import type { ResolvedWorktree } from './runtime-worktree-path-identity'
import { splitWorktreeIdForFilesystem } from '../../shared/worktree/id'
import { isPathInsideOrEqual } from '../../shared/cross-platform-path'
import type { ResolvedWorktreeSnapshot } from './runtime-resolved-worktree-cache'
import { RESOLVED_WORKTREE_CACHE_TTL_MS } from './nightshift-runtime-postlude'
...
import type { RuntimeWorktreeScanCache } from './nightshift-runtime-core'
import { resolveWorktreeScanCacheTtlMs } from './runtime-worktree-scan-cache'

export class NightshiftRuntimeWithListKnownResolvedWorktreesForExplicitTarget extends NightshiftRuntimeWithResolveWorktreeSelector {
