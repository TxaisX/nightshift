...
import { NightshiftRuntimeWithRestoreStructuredAgentSessionTabsOnce } from './nightshift-runtime-restore-structured-agent-session-tabs-once'
import { DEFAULT_WORKTREE_LIST_LIMIT } from './nightshift-runtime-postlude'
...
export class NightshiftRuntimeWithListManagedWorktrees extends NightshiftRuntimeWithRestoreStructuredAgentSessionTabsOnce {
