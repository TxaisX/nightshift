...
import { NightshiftRuntimeWithOnPtyExit } from './nightshift-runtime-on-pty-exit'
...
export class NightshiftRuntimeWithMarkPtyLivenessUnverifiable extends NightshiftRuntimeWithOnPtyExit {
  /**
  ...
  /**
   * Records that Nightshift asked this PTY to stop — a close, a stop, a teardown.
   *
