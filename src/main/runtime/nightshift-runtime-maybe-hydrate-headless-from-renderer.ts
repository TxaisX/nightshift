...
import { NightshiftRuntimeWithSerializeMainTerminalBuffer } from './nightshift-runtime-serialize-main-terminal-buffer'
...
export class NightshiftRuntimeWithMaybeHydrateHeadlessFromRenderer extends NightshiftRuntimeWithSerializeMainTerminalBuffer {
