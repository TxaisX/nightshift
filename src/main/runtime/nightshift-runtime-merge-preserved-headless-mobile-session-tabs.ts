...
import { NightshiftRuntimeWithSyncMobileSessionTabs } from './nightshift-runtime-sync-mobile-session-tabs'
import type {
...
export class NightshiftRuntimeWithMergePreservedHeadlessMobileSessionTabs extends NightshiftRuntimeWithSyncMobileSessionTabs {
