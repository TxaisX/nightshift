...
function publishRendererWorkingPane(runtime: NightshiftRuntimeService, paneTitle: string): void {
...
function publishRendererReleasedPane(runtime: NightshiftRuntimeService, title: string): void {
  runtime.attachWindow(1)
  runtime.syncWindowGraph(1, {
    tabs: [
      {
