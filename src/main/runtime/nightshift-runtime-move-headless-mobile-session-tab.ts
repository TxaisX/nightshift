...
import { NightshiftRuntimeWithPersistHeadlessSessionTabProps } from './nightshift-runtime-persist-headless-session-tab-props'
import type {
...
export class NightshiftRuntimeWithMoveHeadlessMobileSessionTab extends NightshiftRuntimeWithPersistHeadlessSessionTabProps {
