...
import { NightshiftRuntimeWithGetStatus } from './nightshift-runtime-get-status'
...
export class NightshiftRuntimeWithNotifySshStateChanged extends NightshiftRuntimeWithGetStatus {
