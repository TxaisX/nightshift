...
import { NightshiftRuntimeWithHasRecentTerminalOutputPath } from './nightshift-runtime-has-recent-terminal-output-path'
import type { RuntimeCommandSurfaceHost } from './nightshift-runtime-core'

export class NightshiftRuntimeWithOnClientDisconnected extends NightshiftRuntimeWithHasRecentTerminalOutputPath {
