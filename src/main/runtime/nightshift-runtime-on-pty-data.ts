...
import { NightshiftRuntimeWithPreparePtyExecutionContext } from './nightshift-runtime-prepare-pty-execution-context'
...
export class NightshiftRuntimeWithOnPtyData extends NightshiftRuntimeWithPreparePtyExecutionContext {
  onPtyData(
    ptyId: string,
    data: string,
    at: number,
