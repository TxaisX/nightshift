...
import { NightshiftRuntimeWithOnClientDisconnected } from './nightshift-runtime-on-client-disconnected'
...
export class NightshiftRuntimeWithOnPtyExit extends NightshiftRuntimeWithOnClientDisconnected {
  onPtyExit(
    ptyId: string,
    exitCode: number,
