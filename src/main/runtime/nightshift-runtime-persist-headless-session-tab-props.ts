...
import { NightshiftRuntimeWithCloseHeadlessMobileTerminalTab } from './nightshift-runtime-close-headless-mobile-terminal-tab'
...
export class NightshiftRuntimeWithPersistHeadlessSessionTabProps extends NightshiftRuntimeWithCloseHeadlessMobileTerminalTab {
