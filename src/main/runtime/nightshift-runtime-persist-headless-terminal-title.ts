...
import { NightshiftRuntimeWithMoveHeadlessMobileSessionTab } from './nightshift-runtime-move-headless-mobile-session-tab'
import type {
...
export class NightshiftRuntimeWithPersistHeadlessTerminalTitle extends NightshiftRuntimeWithMoveHeadlessMobileSessionTab {
