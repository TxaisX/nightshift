...
import { NightshiftRuntimeWithTouchMobileSessionTabsForWorktree } from './nightshift-runtime-touch-mobile-session-tabs-for-worktree'
...
export class NightshiftRuntimeWithPersistTerminalSurfaceRetirements extends NightshiftRuntimeWithTouchMobileSessionTabsForWorktree {
  /**
