...
import { NightshiftRuntimeWithReclaimTerminalForDesktop } from './nightshift-runtime-reclaim-terminal-for-desktop'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './nightshift-runtime-core'

export class NightshiftRuntimeWithPickMostRecentActor extends NightshiftRuntimeWithReclaimTerminalForDesktop {
