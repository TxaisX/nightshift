...
import { NightshiftRuntimeWithRegisterPty } from './nightshift-runtime-register-pty'
...
export class NightshiftRuntimeWithPreparePtyExecutionContext extends NightshiftRuntimeWithRegisterPty {
