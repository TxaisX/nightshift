...
import { NightshiftRuntimeWithGetWorktreePs } from './nightshift-runtime-get-worktree-ps'
...
export class NightshiftRuntimeWithProveRecoveredStructuredTuiPtyProcess extends NightshiftRuntimeWithGetWorktreePs {
