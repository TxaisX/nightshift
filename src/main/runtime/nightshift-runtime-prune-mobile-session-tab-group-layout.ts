...
import { NightshiftRuntimeWithScheduleMobileSessionTabsChanged } from './nightshift-runtime-schedule-mobile-session-tabs-changed'
...
export class NightshiftRuntimeWithPruneMobileSessionTabGroupLayout extends NightshiftRuntimeWithScheduleMobileSessionTabsChanged {
