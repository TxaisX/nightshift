...
import { NightshiftRuntimeWithStateFields } from './nightshift-runtime-state-fields'
import {
...
export class NightshiftRuntimeWithPtyForegroundProcessReads extends NightshiftRuntimeWithStateFields {
