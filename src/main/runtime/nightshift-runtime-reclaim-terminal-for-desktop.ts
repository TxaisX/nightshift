...
import { NightshiftRuntimeWithMobileTookFloor } from './nightshift-runtime-mobile-took-floor'
import {
  MOBILE_AUTO_RESTORE_FIT_MAX_MS,
  MOBILE_AUTO_RESTORE_FIT_MIN_MS
} from './nightshift-runtime-postlude'

export class NightshiftRuntimeWithReclaimTerminalForDesktop extends NightshiftRuntimeWithMobileTookFloor {
