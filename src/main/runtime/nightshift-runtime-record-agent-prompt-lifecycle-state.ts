...
import { NightshiftRuntimeWithCreateTerminalSideEffectCommandCodeDetector } from './nightshift-runtime-create-terminal-side-effect-command-code-detector'
import type { AgentStatus } from '../../shared/agent-detection'
import { findLastCompleteOscTitleRange } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithRecordAgentPromptLifecycleState extends NightshiftRuntimeWithCreateTerminalSideEffectCommandCodeDetector {
