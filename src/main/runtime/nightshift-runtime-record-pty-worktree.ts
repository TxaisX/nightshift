...
import { NightshiftRuntimeWithRefreshRepoWorktreeScan } from './nightshift-runtime-refresh-repo-worktree-scan'
...
export class NightshiftRuntimeWithRecordPtyWorktree extends NightshiftRuntimeWithRefreshRepoWorktreeScan {
