...
import { NightshiftRuntimeWithListKnownResolvedWorktreesForExplicitTarget } from './nightshift-runtime-list-known-resolved-worktrees-for-explicit-target'
...
export class NightshiftRuntimeWithRefreshRepoWorktreeScan extends NightshiftRuntimeWithListKnownResolvedWorktreesForExplicitTarget {
  /**
