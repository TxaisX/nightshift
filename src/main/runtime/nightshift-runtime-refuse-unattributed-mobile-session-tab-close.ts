...
import { NightshiftRuntimeWithApplyMobileSessionTabNavigation } from './nightshift-runtime-apply-mobile-session-tab-navigation'
import type { RuntimeMobileSessionTabCloseResult } from '../../shared/runtime-types'

export class NightshiftRuntimeWithRefuseUnattributedMobileSessionTabClose extends NightshiftRuntimeWithApplyMobileSessionTabNavigation {
