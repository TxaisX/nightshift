...
import { NightshiftRuntimeWithInvalidateAllHandlesForPty } from './nightshift-runtime-invalidate-all-handles-for-pty'
...
export class NightshiftRuntimeWithRegisterPty extends NightshiftRuntimeWithInvalidateAllHandlesForPty {
  registerPty(
    ptyId: string,
    worktreeId: string,
