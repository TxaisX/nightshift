...
import { NightshiftRuntimeWithAgentPromptRequestCorrelation } from './nightshift-runtime-agent-prompt-request-correlation'
...
export class NightshiftRuntimeWithResolveAuthoritativeTerminalWaitPermission extends NightshiftRuntimeWithAgentPromptRequestCorrelation {
