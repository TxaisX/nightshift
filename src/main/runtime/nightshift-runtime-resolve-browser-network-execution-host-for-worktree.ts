...
import { NightshiftRuntimeWithTransitionGraphReloadToTerminalState } from './nightshift-runtime-transition-graph-reload-to-terminal-state'
...
import type { ResolvedTerminalWorkspaceLaunchTarget } from './nightshift-runtime-core'
import { AGENT_HOOK_RUNTIME_ENV_KEYS } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithResolveBrowserNetworkExecutionHostForWorktree extends NightshiftRuntimeWithTransitionGraphReloadToTerminalState {
  ...
  protected buildTerminalWorkspaceEnv(
    ...
    const env = {
      ...
      NIGHTSHIFT_WORKTREE_ID: scope.id
    }
    ...
    return {
      ...env,
      NIGHTSHIFT_WORKSPACE_ID: scope.id,
      NIGHTSHIFT_PROJECT_GROUP_ID: scope.folderWorkspace.projectGroupId,
      NIGHTSHIFT_WORKSPACE_ROOT: scope.folderWorkspace.folderPath
    }
  }
