...
import { NightshiftRuntimeWithBindPtyIncarnationHandle } from './nightshift-runtime-bind-pty-incarnation-handle'
...
export class NightshiftRuntimeWithResolveExitWaiters extends NightshiftRuntimeWithBindPtyIncarnationHandle {
