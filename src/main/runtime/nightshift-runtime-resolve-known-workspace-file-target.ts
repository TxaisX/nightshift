...
import { NightshiftRuntimeWithPersistHeadlessTerminalTitle } from './nightshift-runtime-persist-headless-terminal-title'
import {
...
export class NightshiftRuntimeWithResolveKnownWorkspaceFileTarget extends NightshiftRuntimeWithPersistHeadlessTerminalTitle {
  ...
  // RPC, but agents need their own handle at spawn time (via NIGHTSHIFT_TERMINAL_HANDLE
  ...
  protected adoptControllerTerminalHandle(
    ...
    // original NIGHTSHIFT_TERMINAL_HANDLE, but the runtime's in-memory map is gone.
