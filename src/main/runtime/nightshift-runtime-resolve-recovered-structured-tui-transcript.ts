...
import { NightshiftRuntimeWithStopStructuredSessionProcess } from './nightshift-runtime-stop-structured-session-process'
...
export class NightshiftRuntimeWithResolveRecoveredStructuredTuiTranscript extends NightshiftRuntimeWithStopStructuredSessionProcess {
