...
import { NightshiftRuntimeWithGetTerminalInteractiveWait } from './nightshift-runtime-get-terminal-interactive-wait'
import type {
  RuntimeTerminalRead,
...
export class NightshiftRuntimeWithResolveTerminalPane extends NightshiftRuntimeWithGetTerminalInteractiveWait {
