...
import { NightshiftRuntimeWithSplitPtyBackedTerminal } from './nightshift-runtime-split-pty-backed-terminal'
import {
...
export class NightshiftRuntimeWithResolveTerminalSplitSourceAuthority extends NightshiftRuntimeWithSplitPtyBackedTerminal {
  ...
  async prepareClaudeAgentTeamsLeader(args: {
    ...
    if (!handle) {
      throw new Error('claude_agent_teams_requires_nightshift_terminal')
    }
