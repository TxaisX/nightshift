...
import { NightshiftRuntimeWithDeliverPendingMessages } from './nightshift-runtime-deliver-pending-messages'
...
export class NightshiftRuntimeWithResolveWaiter extends NightshiftRuntimeWithDeliverPendingMessages {
