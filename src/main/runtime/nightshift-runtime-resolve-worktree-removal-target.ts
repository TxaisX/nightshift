...
import { NightshiftRuntimeWithRemoveManagedWorktree } from './nightshift-runtime-remove-managed-worktree'
...
export class NightshiftRuntimeWithResolveWorktreeRemovalTarget extends NightshiftRuntimeWithRemoveManagedWorktree {
