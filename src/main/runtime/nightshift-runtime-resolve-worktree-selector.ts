...
import { NightshiftRuntimeWithResolveBrowserNetworkExecutionHostForWorktree } from './nightshift-runtime-resolve-browser-network-execution-host-for-worktree'
...
export class NightshiftRuntimeWithResolveWorktreeSelector extends NightshiftRuntimeWithResolveBrowserNetworkExecutionHostForWorktree {
