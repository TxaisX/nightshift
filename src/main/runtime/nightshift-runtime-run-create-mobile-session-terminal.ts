...
import { NightshiftRuntimeWithCreateMobileSessionTerminal } from './nightshift-runtime-create-mobile-session-terminal'
...
export class NightshiftRuntimeWithRunCreateMobileSessionTerminal extends NightshiftRuntimeWithCreateMobileSessionTerminal {
