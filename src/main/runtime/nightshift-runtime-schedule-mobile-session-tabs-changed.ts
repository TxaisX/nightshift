...
import { NightshiftRuntimeWithStoredMobileSnapshotHasStalePreservedTab } from './nightshift-runtime-stored-mobile-snapshot-has-stale-preserved-tab'
import type {
  BrowserTabInfo,
...
export class NightshiftRuntimeWithScheduleMobileSessionTabsChanged extends NightshiftRuntimeWithStoredMobileSnapshotHasStalePreservedTab {
