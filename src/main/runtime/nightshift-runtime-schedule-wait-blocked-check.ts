...
import { NightshiftRuntimeWithOnPtyData } from './nightshift-runtime-on-pty-data'
import {
...
export class NightshiftRuntimeWithScheduleWaitBlockedCheck extends NightshiftRuntimeWithOnPtyData {
