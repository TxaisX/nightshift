...
import { NightshiftRuntimeWithControllerKnowsPtyIsLive } from './nightshift-runtime-controller-knows-pty-is-live'
...
export class NightshiftRuntimeWithSerializeAgentPromptSubmission extends NightshiftRuntimeWithControllerKnowsPtyIsLive {
