...
import { NightshiftRuntimeWithVisibleSnapshotPreview } from './nightshift-runtime-visible-snapshot-preview'
...
export class NightshiftRuntimeWithSerializeHeadlessTerminalBuffer extends NightshiftRuntimeWithVisibleSnapshotPreview {
