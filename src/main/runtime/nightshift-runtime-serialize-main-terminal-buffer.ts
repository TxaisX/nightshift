...
import { NightshiftRuntimeWithAttachRemoteTerminalSourceRangeConsumer } from './nightshift-runtime-attach-remote-terminal-source-range-consumer'
...
export class NightshiftRuntimeWithSerializeMainTerminalBuffer extends NightshiftRuntimeWithAttachRemoteTerminalSourceRangeConsumer {
  ...
  // Why: daemon-backed PTYs that the runtime adopted after a Nightshift relaunch
