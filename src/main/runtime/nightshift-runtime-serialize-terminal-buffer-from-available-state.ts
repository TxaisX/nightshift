...
import { NightshiftRuntimeWithCreatePtyHeadlessTerminalState } from './nightshift-runtime-create-pty-headless-terminal-state'
import type { TerminalOscLinkRange } from '../../shared/terminal-osc-link-ranges'
import type { PtyProviderBufferSnapshot } from '../providers/types'
import { withTimeout } from './runtime-async-boundaries'

export class NightshiftRuntimeWithSerializeTerminalBufferFromAvailableState extends NightshiftRuntimeWithCreatePtyHeadlessTerminalState {
