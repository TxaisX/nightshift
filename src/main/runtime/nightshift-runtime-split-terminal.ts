...
import { NightshiftRuntimeWithStopExplicitlyClosedTabPtys } from './nightshift-runtime-stop-explicitly-closed-tab-ptys'
import type { TerminalPaneSplitSource } from '../../shared/feature-education-telemetry'
import type { RuntimeTerminalSplit } from '../../shared/runtime-types'
import { randomUUID } from 'node:crypto'

export class NightshiftRuntimeWithSplitTerminal extends NightshiftRuntimeWithStopExplicitlyClosedTabPtys {
  async splitTerminal(
    handle: string,
    opts: {
