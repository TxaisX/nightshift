...
import { NightshiftRuntimeWithCreateAgentPromptRenderGate } from './nightshift-runtime-create-agent-prompt-render-gate'
import type {
...
export class NightshiftRuntimeWithStartTuiIdleVisibleReadProbe extends NightshiftRuntimeWithCreateAgentPromptRenderGate {
