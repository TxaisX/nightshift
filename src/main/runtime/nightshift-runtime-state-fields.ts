...
import { NightshiftRuntimeWithLinearCommands } from './nightshift-runtime-linear-commands'
...
export class NightshiftRuntimeWithStateFields extends NightshiftRuntimeWithLinearCommands {
  constructor(
    ...
    deps?: {
      ...
      // runs under `nightshift serve`, so remote/SSH hosts would silently drop
    ...
    // even on headless `nightshift serve` hosts where registerCoreHandlers never runs.
