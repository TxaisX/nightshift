...
import { NightshiftRuntimeWithFocusTerminal } from './nightshift-runtime-focus-terminal'
import { EXPLICIT_TERMINAL_CLOSE_STOP_TIMEOUT_MS } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithStopExplicitlyClosedTabPtys extends NightshiftRuntimeWithFocusTerminal {
