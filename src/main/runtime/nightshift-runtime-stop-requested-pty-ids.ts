...
import { NightshiftRuntimeWithRuntimeId } from './nightshift-runtime-runtime-id'
...
export class NightshiftRuntimeWithStopRequestedPtyIds extends NightshiftRuntimeWithRuntimeId {
