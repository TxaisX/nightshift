...
import { NightshiftRuntimeWithProveRecoveredStructuredTuiPtyProcess } from './nightshift-runtime-prove-recovered-structured-tui-pty-process'
...
import { isPathWithinDirectory } from './nightshift-runtime-core'

export class NightshiftRuntimeWithStopStructuredSessionProcess extends NightshiftRuntimeWithProveRecoveredStructuredTuiPtyProcess {
