...
import { NightshiftRuntimeWithStartTuiIdleVisibleReadProbe } from './nightshift-runtime-start-tui-idle-visible-read-probe'
...
export class NightshiftRuntimeWithStructuredAgentSessionLaunchTui extends NightshiftRuntimeWithStartTuiIdleVisibleReadProbe {
