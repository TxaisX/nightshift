...
import { NightshiftRuntimeWithStructuredAgentSessionReproveTuiOwner } from './nightshift-runtime-structured-agent-session-reprove-tui-owner'
...
export class NightshiftRuntimeWithStructuredAgentSessionRecoverTuiOwner extends NightshiftRuntimeWithStructuredAgentSessionReproveTuiOwner {
