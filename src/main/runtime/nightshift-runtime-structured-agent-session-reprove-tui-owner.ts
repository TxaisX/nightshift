...
import { NightshiftRuntimeWithStructuredAgentSessionLaunchTui } from './nightshift-runtime-structured-agent-session-launch-tui'
...
export class NightshiftRuntimeWithStructuredAgentSessionReproveTuiOwner extends NightshiftRuntimeWithStructuredAgentSessionLaunchTui {
