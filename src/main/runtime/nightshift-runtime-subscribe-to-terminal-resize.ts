...
import { NightshiftRuntimeWithApplyMobileDisplayMode } from './nightshift-runtime-apply-mobile-display-mode'
...
export class NightshiftRuntimeWithSubscribeToTerminalResize extends NightshiftRuntimeWithApplyMobileDisplayMode {
