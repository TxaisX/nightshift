...
import { NightshiftRuntimeWithAttachWindow } from './nightshift-runtime-attach-window'
import type {
...
export class NightshiftRuntimeWithSyncWindowGraph extends NightshiftRuntimeWithAttachWindow {
