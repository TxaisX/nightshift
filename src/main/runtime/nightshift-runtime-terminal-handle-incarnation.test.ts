...
function makeRuntime(): { runtime: NightshiftRuntimeService; writes: string[] } {
  const writes: string[] = []
...
function syncGraph(runtime: NightshiftRuntimeService): void {
...
function register(runtime: NightshiftRuntimeService, incarnationId: string): void {
