...
describe('NightshiftRuntimeService terminal retirement host partitioning (STA-3463)', () => {
  ...
  it('waits for provider retirement on a direct worktree stop', async () => {
    ...
    const runtime = new NightshiftRuntimeService(harness.store)
