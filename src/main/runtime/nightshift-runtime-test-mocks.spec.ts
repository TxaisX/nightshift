...
import * as setup from './nightshift-runtime-test-mocks/setup.spec'
import * as importedValues from './nightshift-runtime-test-mocks/imported-values.spec'
...
export const NightshiftRuntimeService = importedValues.exportedNightshiftRuntimeService
...
export const parseNightshiftYaml = importedValues.exportedParseNightshiftYaml
...
} from './nightshift-runtime-test-mocks/setup.spec'
...
export { electronMocks } from './nightshift-runtime-test-mocks/setup.spec'
export {
...
export type NightshiftRuntimeService = InstanceType<
  typeof importedValues.exportedNightshiftRuntimeService
>
...
export type { RuntimeTerminalAgentStatusEvent } from './nightshift-runtime'
