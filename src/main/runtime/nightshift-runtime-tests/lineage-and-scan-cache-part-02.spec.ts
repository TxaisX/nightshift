...
import type { WorktreeLineage, WorktreeMeta } from '../nightshift-runtime-test-mocks.spec'
import {
  TEST_REPO_ID,
  TEST_WORKTREE_ID,
  makeWorktreeInfo,
...
describe('NightshiftRuntimeService', () => {
  it('strips Nightshift provenance fields from runtime metadata updates', async () => {
    ...
    await runtime.updateManagedWorktreeMeta(`id:${TEST_WORKTREE_ID}`, {
      ...
      nightshiftCreationWorkspaceLayout: { path: '/tmp', nestWorkspaces: false }
    })
