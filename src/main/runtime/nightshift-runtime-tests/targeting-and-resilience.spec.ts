...
import { createMobileCreateTestNotifier } from '../nightshift-runtime-test-scenario-builders.spec'
...
describe('NightshiftRuntimeService', () => {
  ...
  describe('stale terminal handle resolution (#7718)', () => {
    function syncSingleTerminalGraph(runtime: NightshiftRuntimeService, ptyId: string): void {
    ...
    function issueLeafHandle(runtime: NightshiftRuntimeService, ptyId: string): string {
