...
import { acknowledgeAgentPromptSubmit } from '../nightshift-runtime-test-mocks.spec'
import {
  TEST_WORKTREE_PATH,
    ...
    runtime.onPtyData(
      ...
      [
        ...
        [
          ...
          'Run /review on my current changes gpt-5.5 high ~/nightshift/workspaces/nightshift/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/nightshift/workspaces/nightshift/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/nightshift/workspaces/nightshift/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/nightshift/workspaces/nightshift/cli-debug\n'
        ].join('')
