...
import type { WorkspaceSessionState } from '../nightshift-runtime-test-mocks.spec'
import {
  HEADLESS_LEAF_ID,
...
import { publishLegacyWorkerReveal } from '../nightshift-runtime-test-scenario-builders.spec'

describe('NightshiftRuntimeService', () => {
  it('recovers exported NIGHTSHIFT_TERMINAL_HANDLE from discovered live PTY sessions', async () => {
