...
import { NightshiftRuntimeWithPublishPtyBackedMobileSessionTerminal } from './nightshift-runtime-publish-pty-backed-mobile-session-terminal'
...
export class NightshiftRuntimeWithTouchMobileSessionTabsForWorktree extends NightshiftRuntimeWithPublishPtyBackedMobileSessionTerminal {
