...
import { NightshiftRuntimeWithHasTerminalsForWorktree } from './nightshift-runtime-has-terminals-for-worktree'
...
export class NightshiftRuntimeWithTransitionGraphReloadToTerminalState extends NightshiftRuntimeWithHasTerminalsForWorktree {
