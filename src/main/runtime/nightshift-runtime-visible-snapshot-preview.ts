...
import { NightshiftRuntimeWithCaptureProviderTerminalBuffer } from './nightshift-runtime-capture-provider-terminal-buffer'
...
import { projectTerminalVisibleLines } from './nightshift-runtime-terminal-projection'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { withTimeout } from './runtime-async-boundaries'

export class NightshiftRuntimeWithVisibleSnapshotPreview extends NightshiftRuntimeWithCaptureProviderTerminalBuffer {
