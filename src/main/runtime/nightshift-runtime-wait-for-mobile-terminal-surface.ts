...
import { NightshiftRuntimeWithCreateRuntimeOwnedMobileSessionTerminal } from './nightshift-runtime-create-runtime-owned-mobile-session-terminal'
import type {
  RuntimeMobileSessionCreateTerminalResult,
  RuntimeMobileSessionTerminalClientTab
} from '../../shared/runtime-types'
import { MOBILE_TERMINAL_SURFACE_TIMEOUT_MS } from './nightshift-runtime-core'
...
export class NightshiftRuntimeWithWaitForMobileTerminalSurface extends NightshiftRuntimeWithCreateRuntimeOwnedMobileSessionTerminal {
