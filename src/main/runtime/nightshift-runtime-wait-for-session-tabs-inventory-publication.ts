...
import { NightshiftRuntimeWithCollectMobileVisibleGraphChangedWorktrees } from './nightshift-runtime-collect-mobile-visible-graph-changed-worktrees'

export class NightshiftRuntimeWithWaitForSessionTabsInventoryPublication extends NightshiftRuntimeWithCollectMobileVisibleGraphChangedWorktrees {
