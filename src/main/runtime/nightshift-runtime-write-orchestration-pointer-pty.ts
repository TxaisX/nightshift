...
import { NightshiftRuntimeWithRefreshFloatingWorkspacePtyLiveness } from './nightshift-runtime-refresh-floating-workspace-pty-liveness'
...
export class NightshiftRuntimeWithWriteOrchestrationPointerPty extends NightshiftRuntimeWithRefreshFloatingWorkspacePtyLiveness {
