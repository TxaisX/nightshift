...
import { NightshiftRuntimeWithResolveAuthoritativeTerminalWaitPermission } from './nightshift-runtime-resolve-authoritative-terminal-wait-permission'
...
export class NightshiftRuntimeWithWriteTerminalAgentPrompt extends NightshiftRuntimeWithResolveAuthoritativeTerminalWaitPermission {
  protected async writeTerminalAgentPrompt(
    ...
    // receipt; they must not fail a Dispatch merely because Nightshift cannot prove
