...
import { NightshiftRuntimeWithResolveWaiter } from './nightshift-runtime-resolve-waiter'
import type { RuntimeCommandSurfaceHost } from './nightshift-runtime-core'

class NightshiftRuntimeService extends NightshiftRuntimeWithResolveWaiter {}
type NightshiftRuntimeServiceExport = RuntimeCommandSurfaceHost<NightshiftRuntimeService>
const NightshiftRuntimeServiceExport = NightshiftRuntimeService as unknown as {
  new (
    ...args: ConstructorParameters<typeof NightshiftRuntimeService>
  ): NightshiftRuntimeServiceExport
  readonly prototype: NightshiftRuntimeServiceExport
}
export { NightshiftRuntimeServiceExport as NightshiftRuntimeService }
installRuntimeLinearCommandSurface(NightshiftRuntimeServiceExport.prototype)
...
export { projectTerminalTailLines } from './nightshift-runtime-terminal-projection'
