import type { SubscriptionRegistration } from '../nightshift-runtime'
...
/**
 * Faithful double of the runtime subscription registry (`NightshiftRuntimeService`,
 ...
 * `nightshift-runtime.test.ts` are what pin the real behavior; these doubles only pin routing.
 *
