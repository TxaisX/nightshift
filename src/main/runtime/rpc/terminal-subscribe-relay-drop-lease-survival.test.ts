...
// a real NightshiftRuntimeService, because a relay drop reaches the phone through the predicate.
...
function makeRelayDroppedRuntime(): NightshiftRuntimeService {
  const real = new NightshiftRuntimeService()
...
function createRuntime(real: NightshiftRuntimeService): {
