...
const WORKTREE_PATH = '/Users/dev/nightshift/workspaces/nightshift/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — nightshift/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): NightshiftRuntimeService {
