...
// STA repro (silent-send incident): `nightshift terminal send` to a leaf whose ptyId
...
function publishLeafGraph(runtime: NightshiftRuntimeService, leafPtyId: string): void {
