// Why a sidecar next to nightshift-data.json: scan snapshots rewrite wholesale and can reach hundreds
// of KB; folding them into nightshift-data.json would rewrite the whole state file per scan (the
