 ...
 * and `nightshift serve` alike, and each one used to reach the provider directly. The
...
/**
 * Drops every cached answer for a repo. Called when Nightshift itself opens a review,
