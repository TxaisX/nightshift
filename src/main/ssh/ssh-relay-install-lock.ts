...
export async function isRelayInstallLockStale(
  ...
  try {
    // Why: remote time avoids clock skew between Nightshift clients making a live
 ...
 * one winner while keeping the marker visible to older Windows Nightshift clients.
 */
