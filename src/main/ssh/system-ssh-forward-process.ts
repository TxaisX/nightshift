...
export function spawnSystemSshPortForward(
  ...
  const args = buildSshArgs(target, { ...options, suppressNightshiftControlMaster: true })
  ...
  // Why: port-forward ssh processes are not wired to Nightshift credential prompts;
