...
// through Nightshift. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('Nightshift'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'nightshift-stats.json')
}
