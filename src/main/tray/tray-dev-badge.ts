...
// the 14pt menu-bar template; it fills the empty area left of the nightshift glyph
// so the status item keeps the exact production footprint.
const DEV_BADGE_ROWS = ['##..###.#.#', '#.#.#...#.#', '#.#.##..#.#', '#.#.#...#.#', '##..###..#.']
const BADGE_OFFSET_X = 0
const BADGE_OFFSET_Y = 3
// Why: the nightshift tail's antialiased pixels touch the V's right stroke and make
