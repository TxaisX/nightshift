 ...
 * `lpCurrentDirectory`, and NULL means *inherit the parent's*. Nightshift launched by
 * `nightshift-ide` from a WSL shell inherits `\\wsl.localhost\<distro>\...\<worktree>`
