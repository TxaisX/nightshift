...
// null instead fails open and silently spawns `wsl.exe -d <distro>` for a distro Nightshift
 ...
 *
 * Why: worktrees for WSL repos are created under ~/nightshift/workspaces inside
