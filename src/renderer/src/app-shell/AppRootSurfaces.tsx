...
const LaunchAgentsDialog = lazy(() => import('../components/launch-agents/LaunchAgentsDialog'))
    ...
    <>
      ...
      <Suspense fallback={null}>
        ...
        {activeModal === 'launch-agents' ? (
          <ModalBoundary boundaryId="modal.launch-agents" resetKey>
            <LaunchAgentsDialog />
          </ModalBoundary>
        ) : null}
      ...
      {/* fork: the upstream star-us-on-GitHub nag is removed */}
