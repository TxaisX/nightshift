...
} from './automation-nightshift-save-operations'
import type { AutomationSaveContext } from './automation-save-context'

/** Saves a Nightshift automation, including destination validation and host moves. */
export async function saveNightshiftAutomation(
