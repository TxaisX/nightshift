...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="nightshift-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="nightshift-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="nightshift-diff-comment-popover-label">
          {title ??
