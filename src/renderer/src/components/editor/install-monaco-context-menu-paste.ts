...
import {
  NIGHTSHIFT_CONTEXT_MENU_PASTE_NAME,
  NIGHTSHIFT_CONTEXT_MENU_PASTE_PRIORITY,
 ...
 * Nightshift's trusted IPC bridge instead of the sandbox-blocked navigator.clipboard.
