...
describe('doc link hrefs', () => {
  it('round-trips encoded targets', () => {
    ...
    expect(href).toBe('#nightshift-doc-link=docs%2Fsetup%20guide')
...
describe('remarkMarkdownDocLinks', () => {
  it('runs as a react-markdown remark plugin', () => {
    ...
    expect(html).toContain('<a href="#nightshift-doc-link=other.md">other.md</a>')
  ...
  it('renders aliased doc links with the alias text', () => {
    ...
    expect(html).toContain('<a href="#nightshift-doc-link=other.md">Other note</a>')
  ...
  it('transforms text nodes but not code, links, or images', () => {
    ...
    expect(tree.children?.[1]).toMatchObject({
      type: 'link',
      url: '#nightshift-doc-link=setup-guide'
    })
