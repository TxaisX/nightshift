      ...
      <div className="space-y-2.5">
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect a review provider so Nightshift can show PR or MR status, checks, and reviews.'
          )}
          summary={
            <>
        ...
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect where your team tracks work. Nightshift starts workspaces with the issue title, link, and context already attached.'
          )}
          summary={
