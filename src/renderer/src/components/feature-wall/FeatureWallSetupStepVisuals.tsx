...
// Mac-style terminal traffic-light dots — the signature of a Nightshift terminal pane.
...
// Use Nightshift's browser: a browser pane with a cursor grabbing one highlighted
