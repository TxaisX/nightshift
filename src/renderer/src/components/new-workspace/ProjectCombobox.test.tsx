...
const projects: NewWorkspaceProjectOption[] = [
  ...
  {
    kind: 'project',
    id: 'github:txais/noqa',
    projectId: 'github:txais/noqa',
    displayName: 'noqa',
    badgeColor: '#222222',
    detail: 'txais/noqa'
  },
...
describe('ProjectCombobox', () => {
  ...
  it('selects projects by logical project id', () => {
    ...
    openList()
    act(() => {
      rowFor('txais/noqa').dispatchEvent(new MouseEvent('click', { bubbles: true }))
    })

    expect(onValueChange).toHaveBeenCalledWith('github:txais/noqa')
  })
  ...
  it('commits the armed row on Enter', () => {
    ...
    expect(onValueChange).toHaveBeenCalledWith('github:txais/noqa')
    expect(onValueSelected).toHaveBeenCalledWith('github:txais/noqa')
  })
