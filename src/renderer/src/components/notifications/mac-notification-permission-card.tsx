...
export function useMacNotificationPermissionState(
  ...
  useEffect(() => {
    // Why: while Nightshift's own notifications setting is off, the OS permission
          ...
          <div className="min-w-0 space-y-1">
            <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
              ...
              {translate(
                ...
                'Allow notifications for Nightshift'
              )}
            </div>
          ...
          <div className="min-w-0 space-y-1">
            <div className="flex items-center gap-2 text-sm font-semibold text-amber-700 dark:text-amber-300">
              ...
              {translate(
                ...
                'macOS is not delivering Nightshift notifications'
              )}
            </div>
