...
const EXAMPLE_PROMPTS: string[] = [
  'Using Nightshift CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Nightshift CLI and tell me what's blocked.",
  'With Nightshift CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
