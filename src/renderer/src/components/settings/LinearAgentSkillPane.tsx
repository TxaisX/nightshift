...
import { NIGHTSHIFT_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Nightshift: browse issues, start linked workspaces, and let agents update tickets with /nightshift-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${NIGHTSHIFT_LINEAR_SKILL_NAME}`}
      />
