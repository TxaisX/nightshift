...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'nightshift-ide'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `nightshift-ide` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Nightshift itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Nightshift will register {{value0}} so the command works from WSL terminals.',
