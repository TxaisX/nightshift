...
export const getGeneralWorkspaceSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose whether worktrees created outside Nightshift appear by default.'
    ),
    keywords: [
...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Nightshift CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Nightshift CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Nightshift skill so agents know to use the Nightshift CLI.'
    ),
    keywords: [
