...
describe('repository GitHub avatar resolution', () => {
  ...
  it('force-resolves the live origin owner when a non-fork repo was transferred', async () => {
    // Non-fork repo (upstream resolved to null) transferred txais -> parkerrex.
    ...
    apiMocks.repoSlug.mockResolvedValueOnce({ owner: 'parkerrex', repo: 'nightshift' })
