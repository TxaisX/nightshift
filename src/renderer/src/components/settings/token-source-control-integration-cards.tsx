              ...
              <>
                ...
                <span className="font-mono text-[11px]">
                  {translate(
                    ...
                    'NIGHTSHIFT_AZURE_DEVOPS_ACCESS_TOKEN'
                  )}
                </span>
                {translate(
                ...
                <span className="font-mono text-[11px]">
                  {translate(
                    ...
                    'NIGHTSHIFT_AZURE_DEVOPS_API_BASE_URL'
                  )}
                </span>{' '}
                {translate(
