// Step for AddRepoDialog (nightshift#763), split out so create-project state stays scoped.
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {translate(
            ...
            'Name it and Nightshift will create a real project with sensible defaults.'
          )}
        </DialogDescription>
      </DialogHeader>
