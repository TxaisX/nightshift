...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'nightshift.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves Nightshift's pseudo-localization behavior. Without it the
