  ...
  return (
    <WorktreeCardDetailSection>
      <DetailHeader
        ...
        label={translate('auto.components.sidebar.WorktreeCardMeta.cliHeader', 'Nightshift CLI')}
      />
        ...
        <div className="text-[13px] font-semibold leading-snug text-foreground break-words">
          {provenance.callerTerminalHandle
            ? translate(
                ...
                'Created by an agent via `nightshift worktree create`'
              )
            : translate(
                'auto.components.sidebar.WorktreeCardMeta.cliCreatedFromShell',
                'Created via `nightshift worktree create`'
              )}
        </div>
        {agentLabel ? (
