...
export const WORKSPACE_STATUS_DRAG_TYPE = 'application/x-nightshift-worktree-id'
export const WORKSPACE_STATUS_DRAG_IDS_TYPE = 'application/x-nightshift-worktree-ids'
