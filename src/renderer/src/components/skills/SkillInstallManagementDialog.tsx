    ...
    try {
      ...
      setError(
        translate(
          ...
          'Nightshift could not inspect managed installs on this machine.'
        )
      )
    } finally {
      if (generation === loadGeneration.current) {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Nightshift account to load version history.'
              )
            : operation.message
        )
        return
    ...
    try {
          ...
          setError(
            operation.status === 'reconnect-required'
              ? translate(
                  ...
                  'Reconnect your Nightshift account before changing versions.'
                )
              : operation.message
          )
          return
      ...
      setError(
        translate(
          ...
          'Nightshift could not verify the requested version.'
        )
      )
    } finally {
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Nightshift could not safely remove this skill.'
        )
      )
    } finally {
      setBusy(false)
