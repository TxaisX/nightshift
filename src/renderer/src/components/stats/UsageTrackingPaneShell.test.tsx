    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="nightshift"
          options={[
            { value: 'nightshift', label: 'Nightshift worktrees only' },
      ...
      selectionSummary="Nightshift worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Nightshift worktrees only • Last 7 days')).toBeInTheDocument()
