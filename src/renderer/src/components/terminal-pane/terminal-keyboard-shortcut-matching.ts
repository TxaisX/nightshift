...
export function resolveTerminalKeyboardShortcutAction(
  ...
  terminalShortcutPolicy: Parameters<typeof resolveTerminalShortcutAction>[11] = 'nightshift-first',
...
export function matchFileSearchShortcut(
  ...
  terminalShortcutPolicy: TerminalShortcutPolicy = 'nightshift-first'
): boolean {
  if (e.repeat) {
    return false
  }
