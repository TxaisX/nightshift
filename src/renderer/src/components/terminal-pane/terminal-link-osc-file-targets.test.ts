...
describe('handleOscLink', () => {
  ...
  it('opens local file URL links in Nightshift with the platform modifier on desktop', async () => {
    setPlatform('Windows')
  ...
  it('opens #L file URL links in Nightshift and preserves anchors', async () => {
