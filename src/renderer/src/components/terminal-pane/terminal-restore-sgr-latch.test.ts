...
const UNCLOSED_BOLD_FIXTURE = 'NIGHTSHIFT-SGR-REPRO \x1b[1mBOLD-RUN-LEFT-OPEN\x1b[1;34H'
...
describe('fresh-shell terminal restore SGR state', () => {
  ...
  it.each([
    ...
    const terminal = createTerminal()
    await writeTerminal(terminal, 'NIGHTSHIFT-SGR-REPRO \x1b[1;34mBOLD-RUN-LEFT-OPEN\x1b[1;34H')
