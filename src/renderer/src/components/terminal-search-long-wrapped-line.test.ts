...
/**
 * Regression for crash report 012eb5be (Nightshift 1.4.194, win32): searching a pane
 ...
 * SearchAddon through Nightshift's own `safeFind`, which deliberately rethrows
