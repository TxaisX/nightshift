...
export const APP_MENU_PASTE_EVENT = 'nightshift-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Nightshift already resolved.
  ...
  // Why: for text controls Nightshift has already resolved ownership. Falling back
