...
export type CodexPaneScanResult = {
  ...
  /** Nightshift launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to Nightshift-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting Nightshift before restarting a
