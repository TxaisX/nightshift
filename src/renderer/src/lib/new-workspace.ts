...
// Why: when a repo has no `nightshift.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: NightshiftHooks | null): string {
 ...
 * their `nightshift.yaml` / `.nightshift/issue-command` yet.
 */
