...
export function buildDefaultTerminalOptions(): ITerminalOptions {
  ...
  return {
    ...
    // Why: Nightshift's default terminal cells are taller than many users' baseline
    ...
    // (CSI ? u) know Nightshift accepts enhanced key reporting. Nightshift still writes
