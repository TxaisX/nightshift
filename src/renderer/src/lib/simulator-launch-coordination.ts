...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'nightshift:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'nightshift:emulator-launch-failed'
