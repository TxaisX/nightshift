...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __NIGHTSHIFT_WEB_CLIENT__?: boolean }).__NIGHTSHIFT_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __NIGHTSHIFT_WEB_CLIENT__?: boolean }
