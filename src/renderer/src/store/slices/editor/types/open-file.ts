...
export type OpenFile = {
  ...
  /** Why: routes a Nightshift-owned move's destination-watcher echo into content verification. On the tab so it survives the atomic rekey; operationId supersedes a stale verification on re-move. Not persisted. */
