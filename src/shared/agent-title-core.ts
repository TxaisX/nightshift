...
// a closed set (the native literal plus the labels Nightshift synthesizes from Cursor hooks),
...
// Nightshift's hook-synthesized spinner state, but only once a Cursor-owned title already
