 ...
 *   anchored name  — a name in a position some grammar reserves for identity (Nightshift's `- <agent>`
...
/** Catalog labels known to be emitted as terminal titles, not merely presented in Nightshift's UI. */
...
/**
 * Nightshift renders `<task text>… - <agent>` and owns the suffix; task text cannot reach past it.
