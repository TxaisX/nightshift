// Claude's compact lifecycle, from Nightshift's side.
//
...
// path. So PreCompact proves nothing and Nightshift deliberately does not register it: mapping it to
...
// Stop, so Nightshift must not touch the state.
