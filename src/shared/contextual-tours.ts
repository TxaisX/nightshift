  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Bring your existing logins into Nightshift to stay signed in immediately.',
    ...
    steps: [
      {
        ...
        body: 'Nightshift isolates each task in its own worktree, branched off your base.',
