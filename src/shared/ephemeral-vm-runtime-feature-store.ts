...
const EPHEMERAL_VM_RUNTIME_FEATURES_FILE = 'nightshift-ephemeral-vm-runtime-features.json'
...
const EphemeralVmRuntimeFeatureEntrySchema = z
  .object({
    ...
    recipeCheckoutMode: z.enum(['nightshift-worktree', 'provisioned-root']).optional(),
