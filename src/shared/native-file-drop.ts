...
export const NIGHTSHIFT_INTERNAL_FILE_DRAG_TYPE = 'text/x-nightshift-file-path'
...
export function hasNativeFileDragTypes(
  ...
  return values.includes('Files') && !values.includes(NIGHTSHIFT_INTERNAL_FILE_DRAG_TYPE)
}
