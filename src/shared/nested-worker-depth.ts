 ...
 * workers and those workers may not dispatch further — the behaviour Nightshift
...
export const NESTED_WORKER_DEPTH_EXCEEDED_NEXT_STEPS: readonly string[] = [
  ...
  'To allow deeper nesting, open Settings → Orchestration in the Nightshift desktop app and raise "Nested worker depth".'
]
