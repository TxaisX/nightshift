...
const INVENTORY: readonly InventoryGroup[] = [
  ...
  },
  {
    ...
    classification: 'evidence-producer',
    paths: [
      ['src/main/runtime/nightshift-runtime-apply-tracked-pty-title.ts', 2],
      ['src/main/runtime/nightshift-runtime-get-pty-record-for-pane-key.ts', 2],
      ['src/main/runtime/nightshift-runtime-get-unpersisted-tracked-title-for-pty.ts', 2],
      ['src/main/runtime/nightshift-runtime-maybe-hydrate-headless-from-renderer.ts', 2],
      ['src/main/runtime/nightshift-runtime-record-agent-prompt-lifecycle-state.ts', 2],
  ...
  },
  {
    ...
    paths: [
      ...
      ['src/main/runtime/nightshift-runtime-write-orchestration-pointer-pty.ts', 2]
    ]
  }
]
