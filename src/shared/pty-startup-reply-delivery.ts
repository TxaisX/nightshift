...
// discipline sits between Nightshift and the querying program can echo it straight back out as
...
//
// The reply is written IMMEDIATELY, in the caller's turn. Nightshift used to withhold it until
