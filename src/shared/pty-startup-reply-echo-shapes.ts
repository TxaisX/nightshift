...
/**
 * ECHOCTL carets EVERY control, not just ESC. Every OSC reply Nightshift emits is ST-terminated
...
export function replyEchoProjections(
  ...
  if (ownerBackend === 'windows-conpty') {
    ...
    // was reported against — which is every OSC reply Nightshift emits. Whether conhost leaves a
