...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote nightshift runtime|remote nightshift runtime closed the connection|timed out (?:waiting for|while connecting to) the remote nightshift runtime/i
