...
const BROWSER_UNAVAILABLE_MESSAGES: Record<RuntimeBrowserUnavailableReason, string> = {
  unconfigured:
    'Browser automation has no backend on this host. Install the Nightshift desktop app, or set NIGHTSHIFT_BROWSER_EXECUTABLE to a Chromium executable.',
  driver_missing:
  ...
  executable_not_found: 'NIGHTSHIFT_BROWSER_EXECUTABLE points at a path that does not exist.',
  executable_not_executable:
    'NIGHTSHIFT_BROWSER_EXECUTABLE points at a file that is not executable by this host.',
  electron_start_failed: 'The installed Electron browser provider failed to start.',
  chromium_start_failed:
    'The Chromium browser provider named by NIGHTSHIFT_BROWSER_EXECUTABLE failed to start.',
