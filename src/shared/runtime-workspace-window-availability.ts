...
// Why: a headed Nightshift server keeps answering status.get after its workspace window
...
// window exists (nightshift-runtime.ts:4806), so pairing it with a non-ready graph is the
