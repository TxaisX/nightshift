...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Nightshift can detect', () => {
  ...
  it("follows Nightshift's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Nightshift detects trae via `traecli`, which tui-agent-config calls an alias
