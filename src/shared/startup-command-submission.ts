/**
 * Builds the exact bytes Nightshift writes into an interactive shell to deliver and
...
export type StartupCommandSubmissionOptions = {
  ...
  submit: string
  /** Whether the target line editor has bracketed-paste mode active (Nightshift's
