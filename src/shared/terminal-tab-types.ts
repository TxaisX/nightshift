...
export type TerminalTab = {
   ...
   *  Why: agent CLIs overwrite the live title via OSC updates, but Nightshift still
  ...
  startupCwd?: string
  /** Why: the coding-harness agent Nightshift launched in this tab. Lets the tab bar
