...
// Run: NIGHTSHIFT_TOOLTIP_PREVIEW=1 pnpm exec playwright test --config tests/playwright.config.ts \
...
test.skip(
  process.env.NIGHTSHIFT_TOOLTIP_PREVIEW !== '1',
  'Preview only; run with NIGHTSHIFT_TOOLTIP_PREVIEW=1'
)
