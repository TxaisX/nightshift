...
export const GOLDEN_GIT_AUTHOR_NAME = 'Nightshift E2E'
export const GOLDEN_GIT_AUTHOR_EMAIL = 'nightshift-e2e@example.invalid'
...
export function installPassingNodePreCommitHook(fixture: GoldenWorktree): string {
  const hooksPath = mkdtempSync(path.join(os.tmpdir(), 'nightshift-e2e-git-hooks-'))
