...
// Nightshift's own add/remove path — the one thing that invalidates the main-process
 ...
 * raw `git worktree add` that Nightshift never observed still becomes visible.
 */
