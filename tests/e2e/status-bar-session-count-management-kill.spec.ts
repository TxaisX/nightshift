 ...
 * daemon client (a previous app generation, `nightshift serve`, a second Nightshift client) this window's main
...
test.describe('Status bar CLI session count', () => {
  test('drops after Manage Sessions kills a foreign daemon session, popover never opened', async ({
    ...
    // A second daemon client, connected to the app's own daemon exactly as another Nightshift client
