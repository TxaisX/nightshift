...
test.describe('Tab visibility with closed sidebar', () => {
  ...
  test('first tab stays visible after Cmd+B collapses the sidebar', async ({ nightshiftPage }) => {
    ...
    await pressShortcut(nightshiftPage, 'b')
  ...
  test('sidebar toggle and Back button stay separated after sidebar collapse', async ({
    ...
    await nightshiftPage.addInitScript(() => {
