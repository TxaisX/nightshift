...
// irreducible core (Nightshift.exe needs icu + snapshots even as node; the daemon
...
export function resolveTierFileSet(inv, tier) {
  ...
  // Core: exe + runtime data blobs live next to Nightshift.exe in win-unpacked.
  addFile(inv.hostExe, 'Nightshift.exe')
