...
//
// GitHub #7742: when Nightshift's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Nightshift on the same box is never touched.
 */
