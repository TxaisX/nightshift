...
Function QuoteArgument(value)
  If InStr(value, Chr(34)) > 0 Or InStr(value, vbCr) > 0 Or InStr(value, vbLf) > 0 Then
    Err.Raise vbObjectError + 1, "real-nightshift-detached-launcher", "Invalid argument"
  End If
...
If args.Count = 0 Then
  Err.Raise vbObjectError + 2, "real-nightshift-detached-launcher", "Missing executable"
End If
